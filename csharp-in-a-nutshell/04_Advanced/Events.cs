...
public class EventsPlayground : IPlayground
{
    public void Play()
    {
        ...
        stock.PriceChanged += alertService.stock_PriceChanged;
        stock.Price = 120M;
        stock.Price = 130M;
        stock.Price = 150M; // this will trigger the alert
        ...
        Video video = new Video() { Title = "My Vacation" };
